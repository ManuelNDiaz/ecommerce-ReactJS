...
const objetos = [
  ...
  title : 'Monitor Gigabyte 34" curvo 144hz', price : 299.999, category : 'monitores'},
  ...
  title : 'Nvidia Gigabyte GTX 1050 TI', price : 105.499, category : 'graficas'},
  ...
  title : 'Procesador Ryzen 9 5050x', price : 284.499, category : 'hardware'},
  {id: 20, img : "http://intech.com.gt/sU/files/articulos/1675106129.png", 
  title : 'Procesador Intel I9 11900k', price : 220.999, category : 'hardware'},
  ...
  title : 'Procesador Ryzen 7 5700g', price : 100.099, category : 'hardware'},
]
...
const ItemListContainer = ({ greeting }) => {
  ...
  useEffect (() => {
    ...
    if (categoryid) {
      getData.then (res => setData(res.filter( objs => objs.category === categoryid)))
    }else{
